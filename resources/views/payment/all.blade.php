...
<div class="container-fluid mt--7">
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-10">
                            <h3 class="mb-0">{{ __('Scholarship Waiting List') }}</h3>
                        </div>
                        <div class="col-2">
                    ...
                    <table class="table align-items-center table-flush" id="datatable-buttons">
                        ...
                        @foreach ($trainees as $trainee)
                            <tr>
                                ...
                                <td><a href="{{ route('trainee.assignenewfund', ['id' => $trainee->id]) }}" class="btn-sm btn-primary">Assign</a></td>
                                <td class="text-right">
                                    <div class="dropdown">
                        ...
                        <form action="" method="get" id="selectForm">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-sm-8 col-8">
                                    <small class="d-block text-uppercase font-weight-bold mb-4 d-flex justify-content-center">Samurdi Document</small>
                                    <div class ="d-flex justify-content-center">
                                        <span class="zoom" id="ex3">
                                            <img src="/images/course_1.jpg" alt="Rounded image" class="img-fluid rounded shadow-lg p-3 mb-5 bg-secondry rounded" style="width: 100%;">
                                        </span>                                  
                                    </div>
                                </div>                                                                    
                            </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="funds[]" class="form-control course-select" multiple="multiple">
                                        ...
                                        <option value="{{ $fund->id }}"
                                            {{in_array($fund->id, old("payments") ?: []) ? "selected": ""}}>
    ...
    $('#selectModal').on('show.bs.modal', function(event) {
        ...
        form.action = '/trainee/assignefund/' + id
    })
