    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="/scholarship/document/upload/{{$trainee->id}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
