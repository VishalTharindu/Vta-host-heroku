...
@section('content')
@include('users.partials.header', ['title' => __('Assign Scholarship')])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Assign Scholarship') }}</h3>
                        </div>
                ...
                <div class="card-body">                  
                    <form method="get" action="{{ route('trainee.assignefund', ['id' => $trainee->id]) }}"
                        autocomplete="off">
                        @csrf
                        @method('put')
                                    ...
                                    <div class="form-group{{ $errors->has('funds') ? ' has-danger' : '' }}">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ $fund->id }}"
                                                {{in_array($fund->id, old("funds") ?: []) ? "selected": ""}}>
                                ...
                                <div class="col-sm-6 col-6 d-flex justify-content-center">                                  
                                    ...
                                    <div class ="d-flex justify-content-center">
                                        <span class="zoom" id="ex3">
                                            <img src="{{ asset('storage/ForumA/'.$trainee->forumA) }}" alt="Forum A" class="img-fluid rounded shadow-lg p-3 mb-5 bg-secondry rounded" style="width: 100%;">
                                        </span>                                  
                                    </div>
                                </div>
                                <div class="col-sm-6 col-6 d-flex justify-content-center">                              
                                    <div class ="d-flex justify-content-center">
                                        <span class="zoom" id="ex2">
                                            <img src="{{ asset('storage/ForumB/'.$trainee->forumB) }}" alt="Forum B" class="img-fluid rounded shadow-lg p-3 mb-5 bg-secondry rounded" style="width: 100%;">
                                        </span>                                  
                                    </div>
                                </div>                                                                    
                            </div>
