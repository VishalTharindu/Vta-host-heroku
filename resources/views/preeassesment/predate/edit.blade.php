    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div>
                        <form method="post" action="{{ route('preassesment.update', ['id' => $preAssesment->id]) }}" autocomplete="off">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="course" id="input-batches" value=""
                                            data-toggle="select" required autofocus>
                                            @foreach($courses as $course)
                                            <option value="{{ $course->id }}" 
                                            {{in_array($course->id, old("course") ?:[]) ? "selected": ""}}
                                                @if(($preAssesment->course_id) == ($course->id))
                                                    selected
                                                @endif>
                                                {{ $course->course_name}}
                                                </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            {{in_array($batch->id ,old("batch")?: []) ?"selected" : "" }}
                                            @if(($preAssesment->batch_id) == ($batch->id))
                                                    selected
                                                @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control datepicker" id="datepicker1" name="asses_date"
                                            placeholder="Select date" value="{{$preAssesment->date}}" type="text"
                                        ...
                                        <div class="my-4"></div>
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <button type="submit" class="btn btn-success  center">{{ __('Update')
                                                    }}</button>
                                                </div>                                              
                                            </div>
                                        </div>
