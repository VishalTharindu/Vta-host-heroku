            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-10">
                             <h3 class="mb-10">{{ __('Mark Pre Assesstment Subjects') }}</h3>   
                        </div>
                        <div class="col-2">
                            @isset($recount)
                ...
                <div class="card-body">
                    <div>
                        <form method="post" action="{{ route('preassesment.course.subject.trainee') }}" autocomplete="off">
                            @csrf
    ...
    $(document).ready(function(){
        ...
        $('.dynamic').change(function(){
            if($(this).val() != '')
            {
                ...
                $.ajax({
                    url:"{{ route('preassesment.course.subject.fetch') }}",
                    method:"GET",
