    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('trainingInstitute.store') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="input-name"
                                    ...
                                    placeholder="{{ __('Company Name') }}" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="input-address"
                                    ...
                                    placeholder="{{ __('Enter the address seperating from commas') }}" value="{{ old('address') }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_no" id="input-address"
                                    ...
                                    placeholder="{{ __('Enter the phone number') }}" value="{{ old('phone_no') }}" required autofocus>
