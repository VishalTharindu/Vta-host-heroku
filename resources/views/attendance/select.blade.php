            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('View Attendance') }}</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <form method="post" action="{{ route('attendance.view') }}" autocomplete="off">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-sm btn-success px-4 float-right">{{ __('Search')
                                    }}</button>
                            </div>
                    </div>
                    </form>
                ...
                <div class="ml-4 mr-4">
                    <form method="post" action="{{ route('attendance.view') }}" autocomplete="on">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-course">{{ __('Trainee NIC')
                                        }}</label>
                                    <input type="text" name="nic" id="input-nic"
                                        class="form-control form-control-alternative{{ $errors->has('nic') ? ' is-invalid' : '' }}"
                                        placeholder="{{ __('Trainee NIC') }}" value="{{ old('nic') }}" required
                                        autofocus>
                ...
                <div class="card-header">
                    @if (isset($nic))
                    <h3 class="mb-0">{{$nic}} - Trainee Attendance</h3>
        ...
        buttons: [
            {
                ...
                title: 
                @if (isset($nic))
                    '{{$attendances[0]->trainee->name_with_initials}} - {{$nic}} - Trainee Attendance'
                @endif
