...
@section('content')
@include('users.partials.header', ['title' => __('Edit Staff')])
    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('adminStaff.update', ['id' => $adminStaff->id]) }}"
                        autocomplete="off">
                        @csrf
                        @method('put')
                        <div class="pl-lg-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="name" id="input-name"
                                            ...
                                            placeholder="{{ __('Name') }}" required autofocus value="{{ $adminStaff->name }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('role_id') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="role_id" class="form-control" data-toggle="select"
                                            ...
                                            <option value="{{$role->id}}" @if($role->id == $adminStaff->roles[0]->id)
                                                selected
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="email" id="input-email"
                                            ...
                                            placeholder="{{ __('Email') }}" value="{{ $adminStaff->email }}" required
                                            autofocus>
