...
@section('content')
@include('users.partials.header', ['title' => __('Edit Course Duration')])
        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('courseduration.update', $courseduration) }}"
                        autocomplete="off">
                        @csrf
                        @method('put')
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('course_id') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="course_id" class="form-control" data-toggle="select">
                                            ...
                                            <option value="{{$course->id}}" @if ($course->id ==
                                                $courseduration->course_id)
                                                selected
                                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('batch_id') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="batch_id" class="form-control" data-toggle="select">
                                            ...
                                            <option value="{{ $batch->id }}" @if ($batch->id ==
                                                $courseduration->batch_id)
                                                selected
                                                @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control datepicker" id="datepicker1" name="start_date"
                                                placeholder="Select date" value="{{$courseduration->start_date}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control datepicker" id="datepicker1" name="end_date"
                                                placeholder="Select date" value="{{$courseduration->end_date}}"
                                                type="text" data-date-format="yyyy-mm-dd">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success mt-4 px-4">{{ __('Update Course Duration')
                                    }}</button>
                            </div>
                        </div>
                    </form>
