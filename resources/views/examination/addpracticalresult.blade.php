            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-10">
                             <h3 class="mb-10">{{ __('Mark Final Practical Result') }}</h3>   
                        </div>
                        <div class="col-2">
                            @isset($recount)
                ...
                <div class="card-body">
                    <div>
                        <form method="post" action="{{ route('mark.trainee.finel.practical.result.view') }}" autocomplete="off">
                            @csrf
                    ...
                    <form action="{{route('store.practical.result.trainees.exam')}}" method="post"  autocomplete="off">
                        @csrf
